...
const Layout = () => (
  <Stack>
    ...
    <Stack.Screen name="about" options={{ title: "Back " }} />
    <Stack.Screen name="explore" options={{ title: "Back " }} />
    ...
    <Stack.Screen name="privacy" options={{ title: "Back" }} />
    <Stack.Screen name="terms" options={{ title: "Back" }} />
