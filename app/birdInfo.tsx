...
// Import the images
import americanCrowImage from "../assets/images/exploreLinks/Amcrow.jpg"; // Add the path to the American Crow image
import anotherBirdImage from "../assets/images/exploreLinks/Amgold.jpg"; // Add the path to the second bird image
